    ...
    <>
     <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
            <div>
            <a className="flex-none text-xl font-semibold text-black focus:outline-hidden dark:text-white" href="#" aria-label="Brand">Kenya Coffee Co.</a>
            </div>
            ...
            <li className="inline-block relative pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
                <a className="inline-flex gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">
                Brewing Tips
                </a>
            </li>
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-neutral-400">
            &copy; 2025 Kenya Coffee Co. All rights reserved. Sourcing the finest Arabica beans from Nyeri, Kirinyaga, and the Rift Valley.
        </p>
     </footer>
